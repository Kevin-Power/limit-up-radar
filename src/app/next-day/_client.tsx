...
const MOCK_DATA: DayData[] = [
  {
    ...
    totalLimitUp: 48,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",350,1.8, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("4743","合一","生技新藥","上",280,2.1, 308,+10.00, 308,+10.00, 308,+10.00, +10.00,"續漲停"),
      makeStock("6515","穎崴","半導體設備／檢測","上",780,0.9, 858,+10.00, 858,+10.00, 858,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",85,1.2, 93.5,+10.00, 93.5,+10.00, 93.5,+10.00, +10.00,"續漲停"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",55,1.5, 60.5,+10.00, 60.5,+10.00, 60.5,+10.00, +10.00,"續漲停"),
      makeStock("2007","燁興","鋼鐵","上",8.5,2.5, 9.35,+10.00, 9.35,+10.00, 9.35,+10.00, +10.00,"續漲停"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",95,1.6, 104.5,+10.00, 103.5,+8.95, 104.5,+10.00, +9.65,"續漲停"),
      makeStock("1301","台塑","塑化","上",52,2.8, 56.5,+8.65, 55.8,+7.31, 54.5,+4.81, +6.92,"強漲"),
      makeStock("4977","眾達-KY","光通訊","上",180,1.3, 198,+10.00, 196,+8.89, 198,+10.00, +9.63,"續漲停"),
      makeStock("2458","義隆","IC設計","上",135,1.7, 148.5,+10.00, 146,+8.15, 148.5,+10.00, +9.38,"續漲停"),
      makeStock("2548","華固","營建資產","上",110,3.2, 120,+9.09, 118,+7.27, 115,+4.55, +6.97,"強漲"),
      makeStock("2401","凌陽","IC設計","上",82,2.0, 90,+9.76, 88.5,+7.93, 90,+9.76, +9.15,"強漲"),
      makeStock("1303","南亞","塑化","上",45,1.9, 49,+8.89, 48.5,+7.78, 48,+6.67, +7.78,"強漲"),
      makeStock("2014","中鴻","鋼鐵","櫃",25,3.5, 27.2,+8.80, 26.5,+6.00, 25.8,+3.20, +6.00,"銘碼漲"),
      makeStock("2376","技嘉","AI伺服器／散熱","上",400,2.8, 435,+8.75, 430,+7.50, 425,+6.25, +7.50,"強勢漲"),
      makeStock("3324","雙鴻","AI伺服器／散熱","上",1065,1.5, 1120,+5.16, 1040,-2.35, 985,-7.51, +1.80,"開高走低"),
      makeStock("2379","瑞昱","IC設計","上",530,1.8, 545,+2.83, 538,+1.51, 522,-1.51, +0.94,"開高走低"),
      makeStock("6669","緯穎","AI伺服器／散熱","櫃",3200,1.2, 3380,+5.63, 3120,-2.50, 3080,-3.75, +0.46,"開高走低"),
      makeStock("6446","藥華藥","生技新藥","上",450,0.9, 460,+2.22, 455,+1.11, 445,-1.11, +0.74,"銘碼漲"),
      ...
      makeStock("2330","台積電","半導體設備／檢測","上",920,0.9, 935,+1.63, 912,-0.87, 900,-2.17, -0.47,"開高走低"),
      makeStock("2454","聯發科","IC設計","上",1580,1.0, 1600,+1.27, 1565,-0.95, 1548,-2.03, -0.57,"開高走低"),
      makeStock("2317","鴻海","電子代工","上",205,0.8, 207,+0.98, 202,-1.46, 198,-3.41, -1.30,"直接跌"),
    ],
  },
  {
    ...
    totalLimitUp: 55,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,1.5, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",93.5,1.0, 93.5,+10.00, 93.5,+10.00, 93.5,+10.00, +10.00,"續漲停"),
      makeStock("7795","長廣","電子零組件","櫃",120,0.9, 130,+8.33, 128,+6.67, 127,+5.83, +6.94,"強漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",104.5,1.8, 113,+8.13, 111,+6.22, 109,+4.31, +6.22,"強勢漲"),
      makeStock("1301","台塑","塑化","上",56.5,2.2, 60.5,+7.08, 59,+4.42, 57.8,+2.30, +4.60,"強勢漲"),
      makeStock("4977","眾達-KY","光通訊","上",198,1.5, 214,+8.08, 210,+6.06, 206,+4.04, +6.06,"強勢漲"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",60.5,1.8, 65,+7.44, 63.5,+4.96, 62,+2.48, +4.96,"強勢漲"),
      makeStock("2007","燁興","鋼鐵","上",9.35,2.0, 9.8,+4.81, 9.5,+1.60, 9.15,-2.14, +1.42,"開高走低"),
      makeStock("4743","合一","生技新藥","上",308,2.5, 320,+3.90, 312,+1.30, 300,-2.60, +0.87,"開高走低"),
      makeStock("2548","華固","營建資產","上",120,2.8, 123,+2.50, 118,-1.67, 115,-4.17, -1.11,"開高走低"),
      makeStock("6515","穎崴","半導體設備／檢測","上",858,1.2, 862,+0.47, 840,-2.10, 830,-3.26, -1.63,"直接跌"),
    ],
  },
  {
    ...
    totalLimitUp: 42,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,1.8, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",93.5,1.2, 100,+6.95, 98,+4.81, 96,+2.67, +4.81,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",130,1.0, 140,+7.69, 138,+6.15, 136,+4.62, +6.15,"強漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",113,2.0, 120,+6.19, 118,+4.42, 115,+1.77, +4.13,"強勢漲"),
      makeStock("1301","台塑","塑化","上",60.5,1.8, 63,+4.13, 61.5,+1.65, 59.5,-1.65, +1.38,"開高走低"),
      makeStock("4977","眾達-KY","光通訊","上",214,1.5, 222,+3.74, 218,+1.87, 212,-0.93, +1.56,"開高走低"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",65,1.5, 67,+3.08, 65.5,+0.77, 63,-3.08, +0.26,"開高走低"),
      makeStock("2007","燁興","鋼鐵","上",9.8,1.2, 9.5,-3.06, 9.3,-5.10, 9.1,-7.14, -5.10,"直接跌"),
    ],
  },
  {
    ...
    totalLimitUp: 38,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,2.0, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",100,1.5, 108,+8.00, 106,+6.00, 104,+4.00, +6.00,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",140,1.2, 152,+8.57, 150,+7.14, 148,+5.71, +7.14,"強勢漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",120,1.5, 128,+6.67, 126,+5.00, 123,+2.50, +4.72,"強勢漲"),
      makeStock("1301","台塑","塑化","上",63,1.5, 65,+3.17, 63.5,+0.79, 62,-1.59, +0.79,"開高走低"),
      makeStock("4977","眾達-KY","光通訊","上",222,1.0, 226,+1.80, 220,-0.90, 216,-2.70, -0.60,"開高走低"),
    ],
  },
  {
    ...
    totalLimitUp: 45,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,2.5, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",108,1.8, 118,+9.26, 116,+7.41, 114,+5.56, +7.41,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",152,1.5, 165,+8.55, 163,+7.24, 160,+5.26, +7.02,"強勢漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",128,1.2, 138,+7.81, 136,+6.25, 133,+3.91, +5.99,"強勢漲"),
      makeStock("1301","台塑","塑化","上",65,1.2, 67,+3.08, 65.5,+0.77, 64,-1.54, +0.77,"開高走低"),
      makeStock("4977","眾達-KY","光通訊","上",226,0.9, 230,+1.77, 225,-0.44, 220,-2.65, -0.44,"開高走低"),
      makeStock("2007","燁興","鋼鐵","上",9.5,0.8, 9.2,-3.16, 9.0,-5.26, 8.8,-7.37, -5.26,"直接跌"),
    ],
  },
  {
    ...
    totalLimitUp: 52,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,2.8, 385,+10.00, 385,+10.00, 385,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",118,2.0, 128,+8.47, 126,+6.78, 124,+5.08, +6.78,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",165,1.8, 178,+7.88, 176,+6.67, 173,+4.85, +6.47,"強漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",138,1.5, 148,+7.25, 146,+5.80, 143,+3.62, +5.56,"強勢漲"),
      makeStock("1301","台塑","塑化","上",67,1.5, 70,+4.48, 69,+2.99, 67.5,+0.75, +2.74,"開高走低"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",65,1.2, 69,+6.15, 67.5,+3.85, 66,+1.54, +3.85,"強勢漲"),
      makeStock("4977","眾達-KY","光通訊","上",230,1.0, 235,+2.17, 232,+0.87, 228,-0.87, +0.72,"開高走低"),
      makeStock("2007","燁興","鋼鐵","上",9.2,0.8, 8.9,-3.26, 8.7,-5.43, 8.5,-7.61, -5.43,"直接跌"),
    ],
  },
  {
    ...
    stocks: [
      ...
      makeStock("3017","奇鋐","AI伺服器／散熱","上",385,3.2, 380,+8.57, 376,+6.43, 370,+4.76, +6.59,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",178,2.5, 192,+7.87, 190,+6.74, 186,+4.49, +6.37,"強漲"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",148,1.8, 158,+6.76, 156,+5.41, 153,+3.38, +5.18,"強勢漲"),
      makeStock("1301","台塑","塑化","上",70,1.8, 73,+4.29, 72,+2.86, 70.5,+0.71, +2.62,"開高走低"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",69,1.5, 73,+5.80, 72,+4.35, 70,+1.45, +3.87,"強勢漲"),
      makeStock("4977","眾達-KY","光通訊","上",235,1.2, 242,+2.98, 238,+1.28, 233,-0.85, +1.13,"開高走低"),
      makeStock("4743","合一","生技新藥","上",320,2.0, 332,+3.75, 325,+1.56, 315,-1.56, +1.25,"開高走低"),
      makeStock("2007","燁興","鋼鐵","上",8.9,0.6, 8.6,-3.37, 8.5,-4.49, 8.3,-6.74, -4.87,"直接跌"),
    ],
  },
  {
    ...
    stocks: [
      ...
      makeStock("3017","奇鋐","AI伺服器／散熱","上",380,3.5, 380,+10.00, 380,+10.00, 380,+10.00, +10.00,"續漲停"),
      makeStock("7795","長廣","電子零組件","櫃",192,2.8, 210,+9.38, 208,+8.33, 205,+6.77, +8.16,"續漲停"),
      makeStock("6274","台燿","PCB／CCL銅箔基板","上",158,1.8, 170,+7.59, 168,+6.33, 165,+4.43, +6.12,"強漲"),
      makeStock("1301","台塑","塑化","上",73,2.0, 77,+5.48, 76,+4.11, 74.5,+2.05, +3.88,"強勢漲"),
      makeStock("1471","首利","低價投機／籌碼面","櫃",73,1.5, 78,+6.85, 76.5,+4.79, 75,+2.74, +4.79,"強勢漲"),
      makeStock("4743","合一","生技新藥","上",332,2.2, 345,+3.92, 340,+2.41, 330,-0.60, +1.91,"開高走低"),
      makeStock("4977","眾達-KY","光通訊","上",242,1.2, 250,+3.31, 248,+2.48, 245,+1.24, +2.34,"強勢漲"),
    ],
  },
  {
    ...
    totalLimitUp: 64,
    stocks: [
      makeStock("3017","奇鋐","AI伺服器／散熱","上",380,2.0, 380,+10.00, 380,+10.00, 380,+10.00, +10.00,"續漲停"),
      makeStock("3363","上詮","光通訊","櫃",152,1.8, 165,+8.55, 162,+6.58, 160,+5.26, +6.80,"強漲"),
      makeStock("7795","長廣","電子零組件","櫃",210,1.5, 228,+8.57, 225,+7.14, 222,+5.71, +7.14,"強勢漲"),
      ...
      makeStock("1301","台塑","塑化","上",77,1.5, 80,+3.90, 78,+1.30, 76,-1.30, +1.30,"開高走低"),
      makeStock("2376","技嘉","AI伺服器／散熱","上",435,2.8, 455,+4.60, 448,+2.99, 440,+1.15, +2.91,"強勢漲"),
      makeStock("2458","義隆","IC設計","上",148.5,1.7, 155,+4.38, 152,+2.36, 148,-0.34, +2.13,"開高走低"),
      makeStock("6446","藥華藥","生技新藥","上",450,0.9, 458,+1.78, 452,+0.44, 444,-1.33, +0.30,"開高走低"),
      makeStock("1303","南亞","塑化","上",49,1.2, 50,+2.04, 48.5,-1.02, 47.5,-3.06, -0.68,"直接跌"),
      makeStock("2317","鴻海","電子代工","上",207,0.8, 208,+0.48, 204,-1.45, 200,-3.38, -1.45,"直接跌"),
    ],
  },
];
