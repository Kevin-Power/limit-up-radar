              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-bg-2 text-txt-3 border-b border-border">
                    ...
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revMonth")} onKeyDown={sortKeyDown("revMonth")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revMonth")}>月營收(百萬){sortIcon("revMonth")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revYoY")} onKeyDown={sortKeyDown("revYoY")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revYoY")}>YoY{sortIcon("revYoY")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revMoM")} onKeyDown={sortKeyDown("revMoM")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revMoM")}>MoM{sortIcon("revMoM")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revCum")} onKeyDown={sortKeyDown("revCum")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revCum")}>累計(百萬){sortIcon("revCum")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revCumYoY")} onKeyDown={sortKeyDown("revCumYoY")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revCumYoY")}>累計YoY{sortIcon("revCumYoY")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("price")} onKeyDown={sortKeyDown("price")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("price")}>股價{sortIcon("price")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg1d")} onKeyDown={sortKeyDown("chg1d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg1d")}>1日%{sortIcon("chg1d")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg5d")} onKeyDown={sortKeyDown("chg5d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg5d")}>5日%{sortIcon("chg5d")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg20d")} onKeyDown={sortKeyDown("chg20d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 whitespace-nowrap before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg20d")}>20日%{sortIcon("chg20d")}</th>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-bg-2 text-txt-3 border-b border-border">
                    ...
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revMonth")} onKeyDown={sortKeyDown("revMonth")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revMonth")}>月營收(億){sortIcon("revMonth")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revYoY")} onKeyDown={sortKeyDown("revYoY")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revYoY")}>YoY{sortIcon("revYoY")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revCum")} onKeyDown={sortKeyDown("revCum")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revCum")}>累計(億){sortIcon("revCum")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("revCumYoY")} onKeyDown={sortKeyDown("revCumYoY")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("revCumYoY")}>累計YoY{sortIcon("revCumYoY")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg1d")} onKeyDown={sortKeyDown("chg1d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg1d")}>1日%{sortIcon("chg1d")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg5d")} onKeyDown={sortKeyDown("chg5d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg5d")}>5日%{sortIcon("chg5d")}</th>
                    <th tabIndex={0} role="button" aria-sort={ariaSort("chg20d")} onKeyDown={sortKeyDown("chg20d")} className="relative text-right px-2 py-2 cursor-pointer hover:text-txt-1 before:absolute before:left-0 before:right-0 before:top-1/2 before:-translate-y-1/2 before:min-h-[44px] before:content-['']" onClick={() => toggleSort("chg20d")}>20日%{sortIcon("chg20d")}</th>
                  </tr>
                </thead>
                <tbody>
                  {indFiltered.map((ind) => (
