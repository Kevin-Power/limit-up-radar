...
const DISPOSAL_STOCKS: DisposalStock[] = [
  { code: "3324", name: "雙鴻",   industry: "散熱模組", streak: 5, gain10d: 62.3, daysHit: 5, daysRequired: 5, risk: "高危", status: "預警中",   volumeAnomaly: true },
  { code: "3017", name: "奇鋐",   industry: "散熱模組", streak: 4, gain10d: 55.1, daysHit: 4, daysRequired: 5, risk: "高危", status: "預警中",   volumeAnomaly: true },
  { code: "4174", name: "浩鼎",   industry: "生技製藥", streak: 6, gain10d: 78.5, daysHit: 5, daysRequired: 5, risk: "高危", status: "已處置",   volumeAnomaly: true },
  { code: "6955", name: "億力",   industry: "IC設計",   streak: 5, gain10d: 58.7, daysHit: 5, daysRequired: 5, risk: "高危", status: "已處置",   volumeAnomaly: true },
  { code: "3131", name: "弘塑",   industry: "半導體設備", streak: 3, gain10d: 42.8, daysHit: 3, daysRequired: 5, risk: "注意", status: "正常交易", volumeAnomaly: true },
  { code: "3037", name: "欣興",   industry: "PCB",      streak: 3, gain10d: 38.2, daysHit: 3, daysRequired: 5, risk: "注意", status: "正常交易", volumeAnomaly: false },
  { code: "2388", name: "威盛",   industry: "IC設計",   streak: 3, gain10d: 35.6, daysHit: 3, daysRequired: 5, risk: "注意", status: "正常交易", volumeAnomaly: true },
  { code: "6289", name: "華上",   industry: "面板零件", streak: 3, gain10d: 33.4, daysHit: 3, daysRequired: 5, risk: "注意", status: "預警中",   volumeAnomaly: false },
  { code: "3661", name: "世芯",   industry: "IC設計",   streak: 2, gain10d: 28.9, daysHit: 2, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "6510", name: "精測",   industry: "半導體設備", streak: 2, gain10d: 24.1, daysHit: 2, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "5534", name: "長虹",   industry: "營建",     streak: 2, gain10d: 22.7, daysHit: 2, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: true },
  { code: "2497", name: "怡利電", industry: "車用電子", streak: 2, gain10d: 21.3, daysHit: 2, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "3714", name: "富采",   industry: "LED",      streak: 1, gain10d: 18.5, daysHit: 1, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "6578", name: "湧德",   industry: "被動元件", streak: 1, gain10d: 15.2, daysHit: 1, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "8069", name: "元太",   industry: "面板",     streak: 1, gain10d: 12.8, daysHit: 1, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
  { code: "3708", name: "上緯投控", industry: "複合材料", streak: 1, gain10d: 11.4, daysHit: 1, daysRequired: 5, risk: "觀察", status: "正常交易", volumeAnomaly: false },
];

const HISTORICAL_CASES: HistoricalCase[] = [
  { code: "3324", name: "雙鴻",   disposalDate: "2026-02-18", reason: "連續5日漲停",      duration: "10個交易日", drawdown: -18.5, recovery30d: -5.2 },
  { code: "4174", name: "浩鼎",   disposalDate: "2026-01-08", reason: "10日漲幅超過80%",   duration: "20個交易日", drawdown: -32.1, recovery30d: -12.4 },
  { code: "6955", name: "億力",   disposalDate: "2025-12-15", reason: "連續5日漲停",      duration: "10個交易日", drawdown: -15.8, recovery30d: 3.2 },
  { code: "2388", name: "威盛",   disposalDate: "2025-11-20", reason: "成交量異常+連漲",   duration: "5個交易日",  drawdown: -8.3,  recovery30d: 7.6 },
  { code: "3661", name: "世芯",   disposalDate: "2025-09-03", reason: "10日漲幅超過60%",   duration: "10個交易日", drawdown: -22.4, recovery30d: -8.1 },
  { code: "6510", name: "精測",   disposalDate: "2025-07-11", reason: "連續5日漲停",      duration: "10個交易日", drawdown: -14.2, recovery30d: 1.5 },
  { code: "3037", name: "欣興",   disposalDate: "2025-05-22", reason: "成交量異常放大",    duration: "5個交易日",  drawdown: -6.7,  recovery30d: 12.3 },
  { code: "5534", name: "長虹",   disposalDate: "2025-03-10", reason: "連續5日漲停",      duration: "20個交易日", drawdown: -28.9, recovery30d: -15.6 },
  { code: "3714", name: "富采",   disposalDate: "2025-01-14", reason: "10日漲幅超過55%",   duration: "10個交易日", drawdown: -11.3, recovery30d: 4.8 },
];
