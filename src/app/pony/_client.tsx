...
const MOCK_STOCKS = [
  ...
  { code: "3017", name: "奇鋐", close: 1995, changePct: -2.68, group: "AI 伺服器" },
  { code: "6669", name: "緯穎", close: 3645, changePct: -4.20, group: "AI 伺服器" },
  { code: "2376", name: "技嘉", close: 232.5, changePct: -6.44, group: "AI 伺服器" },
  { code: "6515", name: "穎崴", close: 7885, changePct: -0.57, group: "半導體設備" },
  { code: "6223", name: "旺矽", close: 650, changePct: 2.68, group: "半導體設備" },
  { code: "2330", name: "台積電", close: 1810, changePct: -1.63, group: "半導體" },
  { code: "2454", name: "聯發科", close: 1625, changePct: -4.41, group: "IC 設計" },
  { code: "5274", name: "信驊", close: 3600, changePct: 1.55, group: "IC 設計" },
  { code: "2379", name: "瑞昱", close: 469.5, changePct: -2.09, group: "IC 設計" },
  { code: "2014", name: "中鴻", close: 18.15, changePct: -7.40, group: "鋼鐵" },
  { code: "1301", name: "台塑", close: 44.75, changePct: -5.99, group: "塑化" },
  { code: "1303", name: "南亞", close: 73.8, changePct: -5.87, group: "塑化" },
  { code: "2317", name: "鴻海", close: 196, changePct: -3.45, group: "電子代工" },
  { code: "4743", name: "合一", close: 280, changePct: 6.87, group: "生技" },
  { code: "2401", name: "凌陽", close: 20.5, changePct: -3.30, group: "IC 設計" },
  { code: "3037", name: "欣興", close: 499, changePct: -9.93, group: "PCB" },
  { code: "4977", name: "眾達-KY", close: 185, changePct: -7.73, group: "光通訊" },
  { code: "2458", name: "義隆", close: 131, changePct: -3.68, group: "IC 設計" },
  { code: "3576", name: "聯合再生", close: 21.5, changePct: -6.93, group: "太陽能" },
];
