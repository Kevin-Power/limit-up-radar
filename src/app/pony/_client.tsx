...
const MOCK_STOCKS = [
  ...
  { code: "3017", name: "奇鋐", close: 350, changePct: 10.0, group: "AI 伺服器" },
  { code: "6669", name: "緯穎", close: 3200, changePct: 5.82, group: "AI 伺服器" },
  { code: "2376", name: "技嘉", close: 400, changePct: 4.17, group: "AI 伺服器" },
  { code: "6515", name: "穎崴", close: 780, changePct: 3.45, group: "半導體設備" },
  { code: "6223", name: "旺矽", close: 650, changePct: 2.68, group: "半導體設備" },
  { code: "2330", name: "台積電", close: 920, changePct: 2.12, group: "半導體" },
  { code: "2454", name: "聯發科", close: 1580, changePct: 3.28, group: "IC 設計" },
  { code: "5274", name: "信驊", close: 3600, changePct: 1.55, group: "IC 設計" },
  { code: "2379", name: "瑞昱", close: 530, changePct: 2.91, group: "IC 設計" },
  { code: "2014", name: "中鴻", close: 25, changePct: 10.0, group: "鋼鐵" },
  { code: "1301", name: "台塑", close: 52, changePct: -0.76, group: "塑化" },
  { code: "1303", name: "南亞", close: 45, changePct: -1.32, group: "塑化" },
  { code: "2317", name: "鴻海", close: 205, changePct: 1.48, group: "電子代工" },
  { code: "4743", name: "合一", close: 280, changePct: 6.87, group: "生技" },
  { code: "2401", name: "凌陽", close: 82, changePct: -0.48, group: "IC 設計" },
  { code: "3037", name: "欣興", close: 185, changePct: 3.35, group: "PCB" },
  { code: "4977", name: "眾達-KY", close: 285, changePct: 4.78, group: "光通訊" },
  { code: "2458", name: "義隆", close: 135, changePct: 1.88, group: "IC 設計" },
  { code: "3576", name: "聯合再生", close: 18, changePct: -2.16, group: "太陽能" },
];
