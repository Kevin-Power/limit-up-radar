  ...
  groups: [
    {
      ...
      stocks: [
        { code: "2007", name: "燁興", industry: "鋼鐵", close: 8.52, change_pct: 9.87, volume: 31450000, major_net: 4200000, streak: 1 },
        { code: "2014", name: "中鴻", industry: "鋼鐵", close: 25.15, change_pct: 10.00, volume: 187620000, major_net: 62000000, streak: 2 },
    ...
    },
    {
      ...
      stocks: [
        { code: "6515", name: "穎崴", industry: "半導體設備", close: 780, change_pct: 10.00, volume: 14230000, major_net: 185000000, streak: 3 },
        { code: "6223", name: "旺矽", industry: "半導體設備", close: 650, change_pct: 5.32, volume: 8740000, major_net: 92000000, streak: 1 },
        { code: "7795", name: "長廣", industry: "半導體設備", close: 120, change_pct: 10.00, volume: 21560000, major_net: 38000000, streak: 2 },
    ...
    },
    {
      ...
      stocks: [
        { code: "4977", name: "眾達-KY", industry: "光通訊", close: 180, change_pct: 10.00, volume: 28750000, major_net: 52000000, streak: 2 },
    ...
    },
    {
      ...
      stocks: [
        { code: "3017", name: "奇鋐", industry: "散熱模組", close: 350, change_pct: 10.00, volume: 78540000, major_net: 285000000, streak: 3 },
        ...
        { code: "8210", name: "勤誠", industry: "機殼", close: 310, change_pct: 10.00, volume: 12350000, major_net: 48000000, streak: 2 },
      ],
    },
    {
      name: "塑化 / 油價地緣政治",
      ...
      stocks: [
        { code: "1471", name: "首利", industry: "橡膠", close: 55, change_pct: 9.84, volume: 34720000, major_net: 18000000, streak: 1 },
        { code: "1301", name: "台塑", industry: "塑膠", close: 52, change_pct: 3.25, volume: 142380000, major_net: 78000000, streak: 1 },
        { code: "1303", name: "南亞", industry: "塑膠", close: 45, change_pct: 2.89, volume: 98650000, major_net: 55000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        ...
        { code: "6446", name: "藥華藥", industry: "生技", close: 450, change_pct: 7.23, volume: 28760000, major_net: 115000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "2548", name: "華固", industry: "營建", close: 110, change_pct: 9.95, volume: 23540000, major_net: 35000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        ...
        { code: "2379", name: "瑞昱", industry: "IC設計", close: 530, change_pct: 5.43, volume: 28750000, major_net: 135000000, streak: 1 },
        { code: "2458", name: "義隆", industry: "IC設計", close: 135, change_pct: 9.92, volume: 38620000, major_net: 55000000, streak: 2 },
        { code: "2401", name: "凌陽", industry: "IC設計", close: 82, change_pct: 9.87, volume: 53480000, major_net: 28000000, streak: 1 },
      ],
    },
  ],
};
