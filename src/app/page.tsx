  ...
  groups: [
    {
      ...
      stocks: [
        { code: "2007", name: "燁興", industry: "鋼鐵", close: 8.83, change_pct: 2.32, volume: 31450000, major_net: 4200000, streak: 1 },
        { code: "2014", name: "中鴻", industry: "鋼鐵", close: 18.15, change_pct: -7.40, volume: 187620000, major_net: 62000000, streak: 2 },
    ...
    },
    {
      ...
      stocks: [
        { code: "6515", name: "穎崴", industry: "半導體設備", close: 7885, change_pct: -0.57, volume: 14230000, major_net: 185000000, streak: 3 },
        { code: "6223", name: "旺矽", industry: "半導體設備", close: 650, change_pct: 5.32, volume: 8740000, major_net: 92000000, streak: 1 },
        { code: "7795", name: "長廣", industry: "半導體設備", close: 403.5, change_pct: -7.24, volume: 21560000, major_net: 38000000, streak: 2 },
        { code: "6683", name: "雍智", industry: "IC設計", close: 320, change_pct: 9.89, volume: 16420000, major_net: 45000000, streak: 1 },
      ],
    },
    {
      name: "矽光子 / 高速傳輸",
      ...
      stocks: [
        { code: "4977", name: "眾達-KY", industry: "光通訊", close: 185, change_pct: -7.73, volume: 28750000, major_net: 52000000, streak: 2 },
        { code: "3363", name: "上詮", industry: "光通訊", close: 85, change_pct: 10.00, volume: 39420000, major_net: 35000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "3017", name: "奇鋐", industry: "散熱模組", close: 1995, change_pct: -2.68, volume: 78540000, major_net: 285000000, streak: 3 },
        { code: "3324", name: "雙鴻", industry: "散熱模組", close: 1065, change_pct: 10.00, volume: 29870000, major_net: 420000000, streak: 3 },
        ...
        { code: "8210", name: "勤誠", industry: "機殼", close: 893, change_pct: -2.08, volume: 12350000, major_net: 48000000, streak: 2 },
      ],
    },
    {
      name: "塑化 / 油價地緣政治",
      ...
      stocks: [
        { code: "1471", name: "首利", industry: "橡膠", close: 13.8, change_pct: -1.08, volume: 34720000, major_net: 18000000, streak: 1 },
        { code: "1301", name: "台塑", industry: "塑膠", close: 44.75, change_pct: -5.99, volume: 142380000, major_net: 78000000, streak: 1 },
        { code: "1303", name: "南亞", industry: "塑膠", close: 73.8, change_pct: -5.87, volume: 98650000, major_net: 55000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "6274", name: "台燿", industry: "CCL", close: 95, change_pct: 10.00, volume: 27430000, major_net: 32000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "4743", name: "合一", industry: "生技", close: 280, change_pct: 10.00, volume: 57340000, major_net: 152000000, streak: 2 },
        { code: "6446", name: "藥華藥", industry: "生技", close: 614, change_pct: -4.06, volume: 28760000, major_net: 115000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "2548", name: "華固", industry: "營建", close: 117.5, change_pct: -2.49, volume: 23540000, major_net: 35000000, streak: 1 },
    ...
    },
    {
      ...
      stocks: [
        { code: "5274", name: "信驊", industry: "IC設計", close: 3600, change_pct: 6.78, volume: 5430000, major_net: 245000000, streak: 1 },
        { code: "2379", name: "瑞昱", industry: "IC設計", close: 469.5, change_pct: -2.09, volume: 28750000, major_net: 135000000, streak: 1 },
        { code: "2458", name: "義隆", industry: "IC設計", close: 131, change_pct: -3.68, volume: 38620000, major_net: 55000000, streak: 2 },
        { code: "2401", name: "凌陽", industry: "IC設計", close: 20.5, change_pct: -3.30, volume: 53480000, major_net: 28000000, streak: 1 },
      ],
    },
  ],
};
